...
urlpatterns = [
    ...
    path('liked_evaluations/', views.UserLikedEvaluationAPIView.as_view(), name='user_liked_evaluations'),
    ...
    path('liked_reviews/', views.UserLikedReviewAPIView.as_view(), name='user_liked_reviews'),
