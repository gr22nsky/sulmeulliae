...
urlpatterns = [
    ...
    path("like_list/", views.CommunityLikeListAPIView.as_view(), name="community_like_list"),
    ...
    path("comment/like_list/", views.CommentLikeListAPIView.as_view(), name="comment_like_list"),
